...
<body>
    <div class="main">
        ...
        <div class="second">
            <video id="bgvid">
                <source src="video/Student-hall.mp4" type="video/mp4">
            </video>
        </div>
        ...
        <div class="third" style="display:none;">
            <div class="">
                <div class="row">
				   <!--div class="col-md-4">
                        <center>
                            <img src="images/au.png" style="cursor: pointer; position: fixed;width: 15%;left: 43%;top: 55%;z-index: 99;" id="recruitment">
                        </center>
                    </div-->
                    <div class="col-md-4">
                        <center>
                            <img src="images/support.jpg" data-toggle="modal" data-target="#md1" data-theVideo="https://www.youtube.com/embed/loFtozxZG0s" class="support">
                        </center>
                    </div>
    ...
    <span class="hall">Help Desk</span>
        ...
        <div class="fifth" style="display:none; background-color: rgba(23, 20, 22, 0.18);">
            <center>
                <img src="images/arrow-left.png" class="pull-left click" aria-hidden="true" id="Backtoseconds">
            </center>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 col-xs-4 full-wd-600">
                    <div class="header-topbar-col center767">
                        <ul class="list-inline">
                            ...
                            <li><a href="../student-dashboard">My Profile</a></li>
                        </ul>
                    </div>
                </div>
				<div class="col-lg-2 col-md-4 col-sm-4 col-xs-4 full-wd-600">
                    <div class="header-topbar-col center767">
                        <ul class="list-inline">
                            ...
                            <li><a href="../edit-student-details">Edit Profile</a></li>
                        </ul>
                    </div>
                </div>
					<div class="col-lg-2 col-md-4 col-sm-4 col-xs-4 full-wd-600">
